...
void decimalToBinary(float arg); // Function located at bottom of this file.
int array[4]={0};       // Used in above function and in imageCreation function.
...
Eerr_ErrorReport **err;
{
	...
	layerstack2 = eimg_LayerStackCreate(allnames,1,9,layer->width,
		layer->height,eint_GetInit(),&lcl,EIMG_LAYER_OPTION_END);
	EERR_CHECK(lcl, EFS0("Error creating layer stack")); 
...
/*********************************************************************\
**
** Function: decimalToBinary( float )
**
...
**
\*********************************************************************/
void decimalToBinary(float arg)
{
