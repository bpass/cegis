...
//member functions
public:
	bool			InputShapeFile(CString file);//, void (*FireTotalBytes)(int), void (*FireBytesLeft)(int));
	bool			WriteShapeFile( char* file, int numPolygons);
...
protected:
	...
	bool			setFilename(CString fname);
};
