...
public class RoundGradientPaint
  ...
  public int setCenter(double x, double y)
  {
    mPoint = new Point2D.Double(x,y);
    return 1;
  }
  ...
  {
    mRadius = new Point2D.Double(0,radius);
    return 1;
  }
  ...
  public void setColorPoint(Color newp)
  {
    mPointColor = new Color(newp.getRGB());
  }
  
  public void setColorBackG(Color background)
  {
    mBackgroundColor = new Color(background.getRGB());
  }
}