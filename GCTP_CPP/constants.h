...
enum {GEO=0, UTM, SPCS, ALBERS, LAMCC, MERCAT, PS, POLYC, EQUIDC, TM, STEREO, LAMAZ, AZMEQD,
	  GNOMON, ORTHO, GVNSP, SNSOID, EQRECT, MILLER, VGRINT, HOM, ROBIN, SOM, ALASKA, GOOD,
	  MOLL, IMOLL, HAMMER, WAGIV, WAGVII, OBEQA, USDEF=99};

/* Define unit code numbers to their names */
enum {RADIAN=0, //Radians
	  FEET, //Feet
	  METER, //Meters
	  SECOND, //Seconds
