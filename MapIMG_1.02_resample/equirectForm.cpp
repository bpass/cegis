/****************************************************************************
** Form implementation generated from reading ui file 'equirectForm.ui'
**
** Created: Thu Oct 7 08:49:12 2004
**      by: The User Interface Compiler ($Id: equirectForm.cpp,v 1.1 2004/10/20 16:36:40 jtrent Exp $)
**
...
#include "equirectForm.ui.h"
/*
 *  Constructs a equirectForm as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  TRUE to construct a modal dialog.
 */
equirectForm::equirectForm( QWidget* parent, const char* name, bool modal, WFlags fl )
    : QDialog( parent, name, modal, fl )
{
    if ( !name )
	setName( "equirectForm" );
    setMinimumSize( QSize( 0, 0 ) );
    setMaximumSize( QSize( 350, 320 ) );
    setSizeGripEnabled( TRUE );
    equirectFormLayout = new QVBoxLayout( this, 11, 6, "equirectFormLayout"); 
    ...
    Layout135->addWidget( trueScaleLabel );
 ...
 *  language.
 */
void equirectForm::languageChange()
{
