/****************************************************************************
** mercForm meta object code from reading C++ file 'mercForm.h'
**
** Created: Thu Oct 7 08:49:21 2004
**      by: The Qt MOC ($Id: moc_mercForm.cpp,v 1.1 2004/10/20 16:36:40 jtrent Exp $)
**
...
const char *mercForm::className() const
{
    return "mercForm";
}

QMetaObject *mercForm::metaObj = 0;
static QMetaObjectCleanUp cleanUp_mercForm( "mercForm", &mercForm::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString mercForm::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "mercForm", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString mercForm::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "mercForm", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* mercForm::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	0, 0 );
    cleanUp_mercForm.setMetaObject( metaObj );
    return metaObj;
}

void* mercForm::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "mercForm" ) )
	return this;
...
// SIGNAL changesMade
void mercForm::changesMade( double* t0 )
{
    if ( signalsBlocked() )
	return;
...
// SIGNAL getGCTP
void mercForm::getGCTP( double* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool mercForm::qt_invoke( int _id, QUObject* _o )
{
...
bool mercForm::qt_emit( int _id, QUObject* _o )
{
...
bool mercForm::qt_property( int id, int f, QVariant* v)
{
    return QDialog::qt_property( id, f, v);
}

bool mercForm::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
