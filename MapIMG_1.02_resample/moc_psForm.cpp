/****************************************************************************
** psForm meta object code from reading C++ file 'psForm.h'
**
** Created: Thu Oct 7 08:49:22 2004
**      by: The Qt MOC ($Id: moc_psForm.cpp,v 1.1 2004/10/20 16:36:40 jtrent Exp $)
**
...
const char *psForm::className() const
{
    return "psForm";
}

QMetaObject *psForm::metaObj = 0;
static QMetaObjectCleanUp cleanUp_psForm( "psForm", &psForm::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString psForm::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "psForm", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString psForm::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "psForm", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* psForm::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	0, 0 );
    cleanUp_psForm.setMetaObject( metaObj );
    return metaObj;
}

void* psForm::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "psForm" ) )
	return this;
...
// SIGNAL changesMade
void psForm::changesMade( double* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool psForm::qt_invoke( int _id, QUObject* _o )
{
...
bool psForm::qt_emit( int _id, QUObject* _o )
{
...
bool psForm::qt_property( int id, int f, QVariant* v)
{
    return QDialog::qt_property( id, f, v);
}

bool psForm::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
