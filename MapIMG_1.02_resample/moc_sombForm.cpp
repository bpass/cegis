/****************************************************************************
** sombForm meta object code from reading C++ file 'sombForm.h'
**
** Created: Thu Oct 7 08:49:22 2004
**      by: The Qt MOC ($Id: moc_sombForm.cpp,v 1.1 2004/10/20 16:36:40 jtrent Exp $)
**
...
const char *sombForm::className() const
{
    return "sombForm";
}

QMetaObject *sombForm::metaObj = 0;
static QMetaObjectCleanUp cleanUp_sombForm( "sombForm", &sombForm::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString sombForm::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "sombForm", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString sombForm::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "sombForm", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* sombForm::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
    ...
    static const QUMethod slot_7 = {"updateToolTip", 0, 0 };
	...
	{ "updateToolTip()", &slot_7, QMetaData::Public },
	...
	0, 0 );
    cleanUp_sombForm.setMetaObject( metaObj );
    return metaObj;
}

void* sombForm::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "sombForm" ) )
	return this;
...
// SIGNAL changesMade
void sombForm::changesMade( double* t0 )
{
    if ( signalsBlocked() )
	return;
...
// SIGNAL getGCTP
void sombForm::getGCTP( double* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool sombForm::qt_invoke( int _id, QUObject* _o )
{
...
bool sombForm::qt_emit( int _id, QUObject* _o )
{
...
bool sombForm::qt_property( int id, int f, QVariant* v)
{
    return QDialog::qt_property( id, f, v);
}

bool sombForm::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
