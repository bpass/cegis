/****************************************************************************
** stereoForm meta object code from reading C++ file 'stereoForm.h'
**
** Created: Thu Oct 7 08:49:22 2004
**      by: The Qt MOC ($Id: moc_stereoForm.cpp,v 1.1 2004/10/20 16:36:40 jtrent Exp $)
**
...
const char *stereoForm::className() const
{
    return "stereoForm";
}

QMetaObject *stereoForm::metaObj = 0;
static QMetaObjectCleanUp cleanUp_stereoForm( "stereoForm", &stereoForm::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString stereoForm::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "stereoForm", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString stereoForm::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "stereoForm", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* stereoForm::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
    ...
    static const QUMethod slot_10 = {"sendLat", 1, param_slot_10 };
	...
	{ "sendLat(double*)", &slot_10, QMetaData::Public },
	...
	0, 0 );
    cleanUp_stereoForm.setMetaObject( metaObj );
    return metaObj;
}

void* stereoForm::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "stereoForm" ) )
	return this;
...
// SIGNAL changesMade
void stereoForm::changesMade( double* t0 )
{
    if ( signalsBlocked() )
	return;
...
// SIGNAL getGCTP
void stereoForm::getGCTP( double* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool stereoForm::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 10: sendLat((double*)static_QUType_varptr.get(_o+1)); break;
...
bool stereoForm::qt_emit( int _id, QUObject* _o )
{
...
bool stereoForm::qt_property( int id, int f, QVariant* v)
{
    return QDialog::qt_property( id, f, v);
}

bool stereoForm::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
