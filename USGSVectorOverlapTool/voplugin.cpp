/**
 * @file voplugin.cpp
 * $Id: voplugin.cpp,v 1.4 2004/12/08 18:55:54 ahartman Exp $
 */
...
namespace
{
    const char * ident_ = "$Id: voplugin.cpp,v 1.4 2004/12/08 18:55:54 ahartman Exp $";
...
VOPlugin::~VOPlugin() 
{ 
    imp->qgisInterface->removeToolBarIcon(imp->invokeVOPlugin);
    delete imp; 
} // ~VOPlugin()
