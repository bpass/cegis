...
if (iter == 0)
   ...
   if (*insys != GEO)
     {
		 //if current input zone != last input zone or 
		 //current input datum != lat input datum or
		 //current input projection != last input projection
		 //then new initialization needs to be done.
