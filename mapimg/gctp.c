// $Id: gctp.c,v 1.3 2005/06/02 20:11:44 rbuehler Exp $
...
void gctp(incoor,insys,inzone,inparm,inunit,inspheroid,ipr,efile,jpr,pfile,
          pFile_p, outcoor, outsys,outzone,outparm,outunit,outspheroid,fn27,fn83,iflg)
...
FILE *pFile_p;		/* error file pointer				*/
...
long *iflg;		/* error flag					*/
{
   ...
   *iflg = init(*ipr,*jpr,efile,pfile, pFile_p, pFile_p);
   if (*iflg != 0)
      return;
