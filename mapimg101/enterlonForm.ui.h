// $Id: enterlonForm.ui.h,v 1.2 2005/01/06 19:55:34 jtrent Exp $
...
void enterlonForm::checkSeconds()
{
...
// Put longitude into DDDMMMSSS.SS form
void enterlonForm::setLon()
{
    QString s;
    QString t;
    ...
    // If longitude out of range, don't allow
    if(lon > 180000000 || lon < -1800000000)
    {
    ...
    emit changesMade(lon);
    this->accept();
}

void enterlonForm::getLon()
{
    gctpLon = new double;
    emit getLon( gctpLon );
    ...
    if( *gctpLon != 0.0 )
    {
        ...
        curValue.setNum( (double)*gctpLon, 'f', 6 );
...
void enterlonForm::trimZeros( QString *toTrim )
{
