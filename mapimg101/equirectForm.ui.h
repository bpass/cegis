// $Id: equirectForm.ui.h,v 1.2 2005/01/06 19:55:34 jtrent Exp $
...
void equirectForm::makeChanges()
{
    bool bFlag;

    // Check the radius of sphere value
...
// Set longitude
void equirectForm::setLon( double l )
{
    gctparray[4] = l;
}

// Call dialog to get latitude
void equirectForm::getlat()
{
...
// Set latitude
void equirectForm::setLat(double l)
{
    gctparray[5] = l;
}

// Check sphere edit for valid double
void equirectForm::sphereCheck( const QString & check )
{
...
void equirectForm::feCheck( const QString & check )
{
    bool bFlag = validDouble(check);
    if(!bFlag)
    {
...
void equirectForm::fnCheck( const QString & check )
{
    bool bFlag = validDouble(check);
    if(!bFlag)
    {
...
void equirectForm::sendLon( double * ptr )
{
...
void equirectForm::sendLat( double * ptr )
{
