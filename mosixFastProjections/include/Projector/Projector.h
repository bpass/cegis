...
class Projector
{
  public:
    ...
    //sets
    virtual void setInputFile(std::string & ininfile)
    ...
    void setnewheight(const long int newnewheight) throw();
    void setnewwidth(const long int newnewwidth) throw();
    ...
    MathLib::Point getOutputScale() const throw();
    bool getsamescale() const throw();
    DRect getoutRect() const throw();
    long int getnewheight() const throw();
    long int getnewwidth() const throw();

    void dogetExtents() throw(); // figure out new height, etc. without
                                 //  doing any projection

    //main function which runs the projection
    virtual void project(BaseProgress * progress = NULL)
      throw(ProjectorException);
  ...
  protected:
    ...
    void getExtents(PmeshLib::ProjectionMesh * pmesh)
      throw(ProjectorException);
