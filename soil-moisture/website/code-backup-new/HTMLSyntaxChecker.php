 ...
 *
 *
 *  Altered by Mike Williams -- USGS -- 2004
 */
...
class HTMLSyntaxChecker {
  ...
  /* public accessors */
	...
	/*		'style' => 1, */
		...
		/* block excl form, pre, scripting, hr */
		$this->dtd['p'] = $neededTags;
		$this->dtd['h1'] = $neededTags;
		$this->dtd['h2'] = $neededTags;
		$this->dtd['h3'] = $neededTags;
		...
		$this->dtd['a'] = $neededTags; /* a in a handled elsewhere */
		/* $this->dtd['img'] = $inline; */
		$this->dtd['q'] = $inline;
		$this->dtd['sub'] = $inline;
		$this->dtd['sup'] = $inline;
		...
		/* basic tables */
		$this->dtd['table'] = array('tr' => 1, 'table' => 1, 'br' => 1);
		$this->dtd['tr'] = array('td' => 1, 'th' => 1, 'br' => 1);
		$this->dtd['td'] = array('a' => 1, 
					 'p' => 1,
					 'b' => 1,
					 'u' => 1,
					 'i' => 1,
		...
		$this->dtd['th'] = array('a' => 1, 
					 ...
					 'PCDATA' => 1,
				         'br' => 1);
		/* Mike Williams */
		$this->dtd['b'] = array('u' => 1,
					'i' => 1,
					'PCDATA' => 1);
		$this->dtd['i'] = array('b' => 1,
					'u' => 1,
					'PCDATA' => 1);
		$this->dtd['u'] = array('b' => 1,
					'i' => 1,
					'PCDATA' => 1);
		$this->dtd['h1'] = array('i' => 1,
					'u' => 1,
					'PCDATA' => 1);
		$this->dtd['h2'] = array('i' => 1,
					'u' => 1,
					'PCDATA' => 1);
		$this->dtd['h3'] = array('i' => 1,
					'u' => 1,
					'PCDATA' => 1);
		...
		while($index < strlen($input)) {
			if($input{$index} == '<') {
				...
				if($this->isWhiteSpace($tempstr)) {
					...
					if(isset($this->dtd[$stack[count($stack) - 1]]['PCDATA']) && ($this->dtd[$stack[count($stack) - 1]]['PCDATA']))  {
